...
spellblade keeps a great axe, so its floor reads 86% again. Nine is
Casting in Harness giving two of those back: a hybrid that can buy a
breastplate survives long enough to stop being the shortest fight on
the table.

**Read the round-length failures with the numbers in front of you.**
Four of the nine sit between `2.96` and `3.00` rounds against a
...
- **The crowd loop has positions, and they bite for casters only.**
  ...
  you. A caster opens at its spell's range of ten squares and clears
  six goblins **untouched**; every martial build opens at its own
  reach of one or two, goblins move four, and the crowd arrives and
  swings in the same round it always did. So the whole of the effect
  so far is that a caster stops paying hit points for a crowd it was
  already clearing in a round -- worth `9%` of them to the spellblade
  and less to the others. Nothing else in the crowd loop will move
  until something in it picks up a bow.
